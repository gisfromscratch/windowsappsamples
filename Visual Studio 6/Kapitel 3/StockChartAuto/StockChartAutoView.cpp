// StockChartAutoView.cpp : Implementierung der Klasse CStockChartAutoView
//
...
IMPLEMENT_DYNCREATE(CStockChartAutoView, CView)

BEGIN_MESSAGE_MAP(CStockChartAutoView, CView)
	//{{AFX_MSG_MAP(CStockChartAutoView)
...
/////////////////////////////////////////////////////////////////////////////
// CStockChartAutoView Konstruktion/Destruktion

CStockChartAutoView::CStockChartAutoView()
{
...
BOOL CStockChartAutoView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CStockChartAutoView Zeichnen

void CStockChartAutoView::OnDraw(CDC* pDC)
{
	CStockChartAutoDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CStockChartAutoView Drucken

BOOL CStockChartAutoView::OnPreparePrinting(CPrintInfo* pInfo)
{
	// Standardvorbereitung
	return DoPreparePrinting(pInfo);
}

void CStockChartAutoView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// ZU ERLEDIGEN: Zusätzliche Initialisierung vor dem Drucken hier einfügen
}

void CStockChartAutoView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// ZU ERLEDIGEN: Hier Bereinigungsarbeiten nach dem Drucken einfügen
}

/////////////////////////////////////////////////////////////////////////////
// CStockChartAutoView Diagnose

#ifdef _DEBUG
void CStockChartAutoView::AssertValid() const
{
	CView::AssertValid();
}

void CStockChartAutoView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}

CStockChartAutoDoc* CStockChartAutoView::GetDocument() // Die endgültige (nicht zur Fehlersuche kompilierte) Version ist Inline
{
	ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CStockChartAutoDoc)));
	return (CStockChartAutoDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CStockChartAutoView Nachrichten-Handler

void CStockChartAutoView::OnPrepareDC(CDC* pDC, CPrintInfo* pInfo) 
{
   CRect clientRect;
...
void CStockChartAutoView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
