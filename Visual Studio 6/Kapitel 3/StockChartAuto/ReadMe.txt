========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : StockChartAuto
========================================================================


Diese StockChartAuto-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre StockChartAuto-Anwendung bilden.
...
StockChartAuto.h
	...
	Anwendungsklasse CStockChartAutoApp.
...
res\StockChartAuto.ico
    	Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei StockChartAuto.rc eingebunden.

res\StockChartAuto.rc2
...
StockChartAutoDoc.h, StockChartAutoDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CStockChartAutoDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CStockChartAutoDoc::Serialize).

StockChartAutoView.h, StockChartAutoView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CStockChartAutoView.
    	CStockChartAutoView-Objekte werden verwendet, um CStockChartAutoDoc-Objekte anzuzeigen.

res\StockChartAutoDoc.ico
    	Dies ist eine Symboldatei, die als Symbol für untergeordnete MDI-Fenster 
	der Klasse CStockChartAutoDoc verwendet wird. Dieses Symbol wird durch die
	Haupt-Ressourcendatei StockChartAuto.rc eingebunden.
...
StdAfx.h, StdAfx.cpp
	...
	StockChartAuto.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
