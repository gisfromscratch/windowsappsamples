// StockChartOle.cpp : Legt das Klassenverhalten für die Anwendung fest.
//
...
BEGIN_MESSAGE_MAP(CStockChartOleApp, CWinApp)
	//{{AFX_MSG_MAP(CStockChartOleApp)
...
/////////////////////////////////////////////////////////////////////////////
// CStockChartOleApp Konstruktion

CStockChartOleApp::CStockChartOleApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// Das einzige CStockChartOleApp-Objekt

CStockChartOleApp theApp;
...
// {50CB22AB-0C37-11D2-B53C-006097A8F69A}
static const CLSID clsid =
{ 0x50cb22ab, 0xc37, 0x11d2, { 0xb5, 0x3c, 0x0, 0x60, 0x97, 0xa8, 0xf6, 0x9a } };

/////////////////////////////////////////////////////////////////////////////
// CStockChartOleApp Initialisierung

BOOL CStockChartOleApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_STOCKCTYPE,
		RUNTIME_CLASS(CStockChartOleDoc),
		RUNTIME_CLASS(CChildFrame), // Benutzerspezifischer MDI-Child-Rahmen
		RUNTIME_CLASS(CStockChartOleView));
...
void CStockChartOleApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
