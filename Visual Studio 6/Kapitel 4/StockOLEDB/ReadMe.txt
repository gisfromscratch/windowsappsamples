========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : StockOLEDB
========================================================================


Diese StockOLEDB-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre StockOLEDB-Anwendung bilden.
...
StockOLEDB.h
	...
	Anwendungsklasse CStockOLEDBApp.
...
res\StockOLEDB.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei StockOLEDB.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in StockOLEDB.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt eine Ansicht(View):

StockOLEDBView.h, StockOLEDBView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CStockOLEDBView.
...
StdAfx.h, StdAfx.cpp
	...
	StockOLEDB.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
