========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ODBCChart
========================================================================


Diese ODBCChart-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre ODBCChart-Anwendung bilden.
...
ODBCChart.h
	...
	Anwendungsklasse CODBCChartApp.
...
res\ODBCChart.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ODBCChart.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in ODBCChart.rc, um Schaltflächen für die
...
ODBCChartDoc.h, ODBCChartDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CODBCChartDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CODBCChartDoc::Serialize).

ODBCChartView.h, ODBCChartView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CODBCChartView.
    	CODBCChartView-Objekte werden verwendet, um CODBCChartDoc-Objekte anzuzeigen.

res\ODBCChartDoc.ico
    	Dies ist eine Symboldatei, die als Symbol für untergeordnete MDI-Fenster 
	der Klasse CODBCChartDoc verwendet wird. Dieses Symbol wird durch die
	Haupt-Ressourcendatei ODBCChart.rc eingebunden.
...
StdAfx.h, StdAfx.cpp
	...
	ODBCChart.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
