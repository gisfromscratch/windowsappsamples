// ODBCChartView.cpp : Implementierung der Klasse CODBCChartView
//
...
IMPLEMENT_DYNCREATE(CODBCChartView, CView)

BEGIN_MESSAGE_MAP(CODBCChartView, CView)
	//{{AFX_MSG_MAP(CODBCChartView)
...
/////////////////////////////////////////////////////////////////////////////
// CODBCChartView Konstruktion/Destruktion

CODBCChartView::CODBCChartView()
{
...
BOOL CODBCChartView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CODBCChartView Zeichnen

void CODBCChartView::OnDraw(CDC* pDC)
{
	CODBCChartDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CODBCChartView Drucken

BOOL CODBCChartView::OnPreparePrinting(CPrintInfo* pInfo)
{
	// Standardvorbereitung
	return DoPreparePrinting(pInfo);
}

void CODBCChartView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// ZU ERLEDIGEN: Zusätzliche Initialisierung vor dem Drucken hier einfügen
}

void CODBCChartView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// ZU ERLEDIGEN: Hier Bereinigungsarbeiten nach dem Drucken einfügen
}

/////////////////////////////////////////////////////////////////////////////
// CODBCChartView Diagnose

#ifdef _DEBUG
void CODBCChartView::AssertValid() const
{
	CView::AssertValid();
}

void CODBCChartView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}

CODBCChartDoc* CODBCChartView::GetDocument() // Die endgültige (nicht zur Fehlersuche kompilierte) Version ist Inline
{
	ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CODBCChartDoc)));
	return (CODBCChartDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CODBCChartView Nachrichten-Handler

void CODBCChartView::OnPrepareDC(CDC* pDC, CPrintInfo* pInfo) 
{
   CRect clientRect;
...
void CODBCChartView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
