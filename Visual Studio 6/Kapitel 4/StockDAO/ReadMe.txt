========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : StockDAO
========================================================================


Diese StockDAO-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre StockDAO-Anwendung bilden.
...
res\StockDAO.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei StockDAO.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in StockDAO.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt eine Ansicht(View):

StockDAOView.h, StockDAOView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CStockDAOView.

//Für eine DAO-Datenbankanwendung:
StockDAOSet.h, StockDAOSet.cpp - Die Datensatzgruppe
	Diese Dateien definieren und implementieren die Recordset-Klasse CStockDAOSet,
...
StdAfx.h, StdAfx.cpp
	...
	StockDAO.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
