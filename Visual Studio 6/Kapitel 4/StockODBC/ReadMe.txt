========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : StockODBC
========================================================================


Diese StockODBC-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre StockODBC-Anwendung bilden.
...
StockODBC.h
	...
	Anwendungsklasse CStockODBCApp.
...
res\StockODBC.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei StockODBC.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in StockODBC.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt eine Ansicht(View):

StockODBCView.h, StockODBCView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CStockODBCView.

//Für eine ODBC-Datenbankanwendung:
StockODBCSet.h, StockODBCSet.cpp - Die Datensatzgruppe
	Diese Dateien definieren und implementieren die Recordset-Klasse CStockODBCSet,
	die die Datenbankabfrage und -sammlung durchführt.
...
StdAfx.h, StdAfx.cpp
	...
	StockODBC.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
