========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : OLEDBChart
========================================================================


Diese OLEDBChart-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre OLEDBChart-Anwendung bilden.
...
OLEDBChart.h
	...
	Anwendungsklasse COLEDBChartApp.
...
res\OLEDBChart.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei OLEDBChart.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in OLEDBChart.rc, um Schaltflächen für die
...
OLEDBChartDoc.h, OLEDBChartDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse COLEDBChartDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von COLEDBChartDoc::Serialize).

OLEDBChartView.h, OLEDBChartView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse COLEDBChartView.
    	COLEDBChartView-Objekte werden verwendet, um COLEDBChartDoc-Objekte anzuzeigen.

res\OLEDBChartDoc.ico
    	Dies ist eine Symboldatei, die als Symbol für untergeordnete MDI-Fenster 
	der Klasse COLEDBChartDoc verwendet wird. Dieses Symbol wird durch die
	Haupt-Ressourcendatei OLEDBChart.rc eingebunden.
...
StdAfx.h, StdAfx.cpp
	...
	OLEDBChart.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
