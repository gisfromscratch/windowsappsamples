// OLEDBChartView.cpp : Implementierung der Klasse COLEDBChartView
//
...
IMPLEMENT_DYNCREATE(COLEDBChartView, CView)

BEGIN_MESSAGE_MAP(COLEDBChartView, CView)
	//{{AFX_MSG_MAP(COLEDBChartView)
...
/////////////////////////////////////////////////////////////////////////////
// COLEDBChartView Konstruktion/Destruktion

COLEDBChartView::COLEDBChartView()
{
...
BOOL COLEDBChartView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// COLEDBChartView Zeichnen

void COLEDBChartView::OnDraw(CDC* pDC)
{
	COLEDBChartDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// COLEDBChartView Drucken

BOOL COLEDBChartView::OnPreparePrinting(CPrintInfo* pInfo)
{
	// Standardvorbereitung
	return DoPreparePrinting(pInfo);
}

void COLEDBChartView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// ZU ERLEDIGEN: Zusätzliche Initialisierung vor dem Drucken hier einfügen
}

void COLEDBChartView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// ZU ERLEDIGEN: Hier Bereinigungsarbeiten nach dem Drucken einfügen
}

/////////////////////////////////////////////////////////////////////////////
// COLEDBChartView Diagnose

#ifdef _DEBUG
void COLEDBChartView::AssertValid() const
{
	CView::AssertValid();
}

void COLEDBChartView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}

COLEDBChartDoc* COLEDBChartView::GetDocument() // Die endgültige (nicht zur Fehlersuche kompilierte) Version ist Inline
{
	ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(COLEDBChartDoc)));
	return (COLEDBChartDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// COLEDBChartView Nachrichten-Handler

void COLEDBChartView::OnPrepareDC(CDC* pDC, CPrintInfo* pInfo) 
{
   CRect clientRect;
...
void COLEDBChartView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
