========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : DAOChart
========================================================================


Diese DAOChart-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre DAOChart-Anwendung bilden.
...
res\DAOChart.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei DAOChart.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in DAOChart.rc, um Schaltflächen für die
...
DAOChartDoc.h, DAOChartDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CDAOChartDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CDAOChartDoc::Serialize).

DAOChartView.h, DAOChartView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CDAOChartView.
    	CDAOChartView-Objekte werden verwendet, um CDAOChartDoc-Objekte anzuzeigen.

res\DAOChartDoc.ico
    	Dies ist eine Symboldatei, die als Symbol für untergeordnete MDI-Fenster 
	der Klasse CDAOChartDoc verwendet wird. Dieses Symbol wird durch die
	Haupt-Ressourcendatei DAOChart.rc eingebunden.
...
StdAfx.h, StdAfx.cpp
	...
	DAOChart.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
