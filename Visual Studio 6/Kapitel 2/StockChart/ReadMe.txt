...
StockChart.h
	...
	Anwendungsklasse CStockChartApp.
...
res\StockChart.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei StockChart.rc eingebunden.
...
StockChartDoc.h, StockChartDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CStockChartDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CStockChartDoc::Serialize).

StockChartView.h, StockChartView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CStockChartView.
    	CStockChartView-Objekte werden verwendet, um CStockChartDoc-Objekte anzuzeigen.

res\StockChartDoc.ico
    	Dies ist eine Symboldatei, die als Symbol für untergeordnete MDI-Fenster 
	der Klasse CStockChartDoc verwendet wird. Dieses Symbol wird durch die
	Haupt-Ressourcendatei StockChart.rc eingebunden.
...
StdAfx.h, StdAfx.cpp
	...
	StockChart.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
