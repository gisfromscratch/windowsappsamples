// StockChartView.cpp : Implementierung der Klasse CStockChartView
//
...
IMPLEMENT_DYNCREATE(CStockChartView, CView)

BEGIN_MESSAGE_MAP(CStockChartView, CView)
	//{{AFX_MSG_MAP(CStockChartView)
...
/////////////////////////////////////////////////////////////////////////////
// CStockChartView Konstruktion/Destruktion

CStockChartView::CStockChartView()
{
...
BOOL CStockChartView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CStockChartView Zeichnen

void CStockChartView::OnDraw(CDC* pDC)
{
	CStockChartDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
   ...
   if (nCnt > 0) {
      ...
      // an den Anfang der Liste positionieren
...
/////////////////////////////////////////////////////////////////////////////
// CStockChartView Drucken

BOOL CStockChartView::OnPreparePrinting(CPrintInfo* pInfo)
{
	// Standardvorbereitung
	return DoPreparePrinting(pInfo);
}

void CStockChartView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// ZU ERLEDIGEN: Zusätzliche Initialisierung vor dem Drucken hier einfügen
}

void CStockChartView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}

/////////////////////////////////////////////////////////////////////////////
// CStockChartView Diagnose

#ifdef _DEBUG
void CStockChartView::AssertValid() const
{
	CView::AssertValid();
}

void CStockChartView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}

CStockChartDoc* CStockChartView::GetDocument() // Die endgültige (nicht zur Fehlersuche kompilierte) Version ist Inline
{
	ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CStockChartDoc)));
	return (CStockChartDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CStockChartView Nachrichten-Handler

void CStockChartView::OnPrepareDC(CDC* pDC, CPrintInfo* pInfo) 
{
   CRect clientRect;
...
void CStockChartView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
