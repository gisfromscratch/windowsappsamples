...
CStockChartDebugDoc* CStockChartDebugView::GetDocument() // Die endgültige (nicht zur Fehlersuche kompilierte) Version ist Inline
{
...
void CStockChartDebugView::OnDumpDocument() 
{
   ...
   afxDump << pDoc;
   #else
   MessageBox ("Dump ist nur in der Debug-Version möglich.");
   #endif   		
}
