// StockChartWithDllView.cpp : Implementierung der Klasse CStockChartWithDllView
//
...
#include "StockChartWithDllView.h"
...
IMPLEMENT_DYNCREATE(CStockChartWithDllView, CView)

BEGIN_MESSAGE_MAP(CStockChartWithDllView, CView)
	//{{AFX_MSG_MAP(CStockChartWithDllView)
...
/////////////////////////////////////////////////////////////////////////////
// CStockChartWithDllView Konstruktion/Destruktion

CStockChartWithDllView::CStockChartWithDllView()
{
...
BOOL CStockChartWithDllView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CStockChartWithDllView Zeichnen

void CStockChartWithDllView::OnDraw(CDC* pDC)
{
	CStockChartWithDllDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CStockChartWithDllView Drucken

BOOL CStockChartWithDllView::OnPreparePrinting(CPrintInfo* pInfo)
{
	// Standardvorbereitung
	return DoPreparePrinting(pInfo);
}

void CStockChartWithDllView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// ZU ERLEDIGEN: Zusätzliche Initialisierung vor dem Drucken hier einfügen
}

void CStockChartWithDllView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}

/////////////////////////////////////////////////////////////////////////////
// CStockChartWithDllView Diagnose

#ifdef _DEBUG
void CStockChartWithDllView::AssertValid() const
{
	CView::AssertValid();
}

void CStockChartWithDllView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}

CStockChartWithDllDoc* CStockChartWithDllView::GetDocument() // Die endgültige (nicht zur Fehlersuche kompilierte) Version ist Inline
{
	ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CStockChartWithDllDoc)));
	return (CStockChartWithDllDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CStockChartWithDllView Nachrichten-Handler

void CStockChartWithDllView::OnPrepareDC(CDC* pDC, CPrintInfo* pInfo) 
{
   CRect clientRect;
...
void CStockChartWithDllView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
