...
res\StockChartWithDll.ico
    	Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei StockChartWithDll.rc eingebunden.

res\StockChartWithDll.rc2
...
StockChartWithDllDoc.h, StockChartWithDllDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CStockChartWithDllDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CStockChartWithDllDoc::Serialize).

StockChartWithDllView.h, StockChartWithDllView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CStockChartWithDllView.
    	CStockChartWithDllView-Objekte werden verwendet, um CStockChartWithDllDoc-Objekte anzuzeigen.

res\StockChartWithDllDoc.ico
    	Dies ist eine Symboldatei, die als Symbol für untergeordnete MDI-Fenster 
	der Klasse CStockChartWithDllDoc verwendet wird. Dieses Symbol wird durch die
	Haupt-Ressourcendatei StockChartWithDll.rc eingebunden.
...
StdAfx.h, StdAfx.cpp
	...
	StockChartWithDll.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
